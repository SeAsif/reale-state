...
class Application_Plugin_UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'min_width' => 'Image requires a minimum 400 width',
        'max_height' => 'Image exceeds maximum height',
        'min_height' => 'Image requires a minimum 300 height',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
		...
		if(isset($options['min_width']))
		{
			...
			$error_messages['min_width']="Image requires a minimum ".$min_width." width";
		}
		if(isset($options['min_height']))
		{
			$min_height=$options['min_height'];
			$error_messages['min_height']="Image requires a minimum ".$min_height." width";
		}
	
		if(isset($options['max_number_of_files']))
		{
