<?php
class Customtemp4Controller extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        if ($lp_id != '') {
            ...
            if (($page_data['lp_status'] == 0 && $type == '') || ($page_data['lp_pt_id'] != 10)) {
    ...
    public function step1Action()
    {
		...
		if(!empty($page_data)){					
			...
			$this->view->bullet_point_1=$page_data['lp_bullet_1'];
			$this->view->bullet_point_2=$page_data['lp_bullet_2'];
			$this->view->bullet_point_3=$page_data['lp_bullet_3'];
		...
		else
		{
				...
				$this->view->bullet_point_1="Bullet point text 1 goes here";
				$this->view->bullet_point_2="Bullet point text 2 goes here";
				$this->view->bullet_point_3="Bullet point text 3 goes here";
