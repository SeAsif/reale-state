<?php
class Customtemp5Controller extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        if ($lp_id != '') {
            ...
            if (($page_data['lp_status'] == 0 && $type == '') || ($page_data['lp_pt_id'] != 11)) {
    ...
    public function step1Action()
    {
		...
		if(!empty($page_data)){					
			...
			$this->view->phone_request=$page_data['lp_phone_request'];
